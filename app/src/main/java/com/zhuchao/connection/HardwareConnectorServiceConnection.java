...
import com.zhuchao.service.HardwareConnectorService.HardwareConnectorServiceBinder;
...
public class HardwareConnectorServiceConnection {
	...
	private final ServiceConnection mServiceConnection = new ServiceConnection() {
		...
		public void onServiceConnected(ComponentName className, IBinder binder) {
			...
			HardwareConnectorService hardwareConnectorService = hardwareConnectorServiceBinder.getService();
	...
	public boolean isBound() {
		return (mHardwareConnectorService != null)&& (mHardwareConnectorService.getHardwareConnector() != null);
	}
